...
public class MainHome extends AppCompatActivity {
    ...
    public void helo() {
        db.execSQL("INSERT INTO account  VALUES('mayur@gil.com','Mayur',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('rakesh@gil.com','Rakesh',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('suyash@gil.com','Suyash',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('rahul@gil.com','Rahul',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('sachin@gil.com','Sachin',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('suresh@gil.com','Suresh',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('jack@gil.com','Jack',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('raj@gil.com','Raj',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('rohan@gil.com','Rohan',50000.00)");
        db.execSQL("INSERT INTO account  VALUES('pratik@gil.com','Pratik',50000.00)");
